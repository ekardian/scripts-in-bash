...
if [ "serial-files.txt" ]; then rm -f serial-files.txt; fi
for f in *
  do
...
echo ""
echo -e "\e[1;33mJoin you serialzed files: $ cat serial-files.txt /other/serial-files.txt > all-files.txt\e[0m"
echo ""
